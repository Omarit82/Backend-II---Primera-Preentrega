...
import { viewHome,viewNewProduct,viewProduct,viewLogin, viewRegister, viewCheckout, viewAdministrate,viewTickets,viewStock} from "../controllers/views.controller.js";
...
viewsRouter.get('/view-stock',authorization('Admin'),viewStock)
